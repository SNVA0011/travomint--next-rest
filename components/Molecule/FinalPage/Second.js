              ...
              <div className="px-3 py-4 bg-white payment-modesel">
                ...
                <div className=" row">
                  ...
                  <div className="col-lg-8 col-12 px-lg-4 price-grand-total d-flex flex-column mt-4 mt-lg-0">
                    ...
                    <p className="text-lg">
                      <b>Note:</b> Kindly ensure that the details filled for traveller matches the government issued photo ID. The ticket are non refundable therefore please check all the details twice before moving ahead, such as your Name, Address, Contact Number, etc.
          ...
          <Modal.Title>Confirm Your flightdata</Modal.Title>
                      ...
                      <Modal.Body>
                        ...
                        <p className="text-sm text-gray-600 mb-3 mt-4">
                          <b>Terms & Conditions:</b> Convenience fees are non-refundable. This is a payment processing method and isn't a part of the airline fare integration. This expense incorporates the charges we paid to the concerned bank for providing the electronic infrastructure. This is a non-refundable sum and will not be refunded if the flight is cancelled. It is far beyond the airline's Cancel Fee or Travomint Service Fee.
{" "}
                          <span>
